...
public class Cincin extends Elips implements Runnable {
    ...
    public double hitungLuas() {
        ...
        double luasDalam = super.hitungLuas(semiMayorDalam, semiMinorDalam);
    ...
    public double hitungLuas(double a, double b) {
        if (a <= 0 || b <= 0) {throw new IllegalArgumentException("[Cincin] Parameter harus positif!");}
    ...
    public double hitungLuas(double aLuar, double bLuar, double aDalam, double bDalam
        ...
        double luasLuar = super.hitungLuas(aLuar, bLuar);
        double luasDalam = super.hitungLuas(aDalam, bDalam);
    ...
    public void run() {
        try {
            ...
            progress = 0;
            System.out.println("[" + namaThread + "] START – hitung Cincin");
            ...
            progress = 100;
            statusThread = "DONE";
            System.out.println("[" + namaThread + "] DONE – Luas=" + String.format("%.4f", hasilLuas));
